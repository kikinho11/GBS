...
<body style="height: 100%; background-color: #121212;">
  <div class="w-100 h-100 text-center center-div5">
    <form class="text-white text-center" action="../include/signup.employee.inc.php" method="post">
      <input type="hidden" name="signup" value="signup">
      <h1 style="padding-bottom: 50px;">Crie uma conta funcionário</h1>
      ...
      <div class="col-4 position-relative start-50 end-50 translate-middle text-start" style="padding-top: 10px;">
        <label for="password" class="form-label">Repita senha</label>
        <input type="password" class="form-control" id="password-repeat" name="password-repeat" placeholder="Repita a sua senha:">
      </div>
